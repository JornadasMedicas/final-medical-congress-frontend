    ...
    return (
        <Grid container columns={12} sx={{ display: 'flex', minHeight: responsive ? 'auto' : 'auto', flexDirection: 'column', ml: responsive ? 3 : 20, mr: responsive ? 3 : 20, mt: 2 }}>
            ...
            <Grid size={12} sx={{ mt: 2, height: '100%' }}>
                ...
                {
                    programTab === 1 && <RenderSingleProgram image={`${import.meta.env.VITE_APP_BASE_ROUTE}/programas/2025/TRIPTICO_ENF_25.webp`} url={'TRIPTICO_ENF_25.pdf'} />
                }
                {
                    programTab === 2 && <RenderSingleProgram image={`${import.meta.env.VITE_APP_BASE_ROUTE}/programas/2025/PROGRAMA-QUIMICOS-25.webp`} url={'PROGRAMA_QUIMICOS_25.pdf'} />
                }
                {
                    programTab === 3 && <RenderSingleProgram image={`${import.meta.env.VITE_APP_BASE_ROUTE}/programas/2025/TRIPTICO_EST_25.webp`} url={'TRIPTICO_EST_25.pdf'} />
                }
            </Grid>
            <ModalImagen />
        </Grid>
